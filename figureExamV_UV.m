Fo_studio_fe = V_UV('./fileTinHieuMoi/studio_F1.wav', 'studio female');
%Fo_studio_ma = V_UV('./fileTinHieuMoi/studio_M1.wav', 'studio male');
%Fo_phone_fe = V_UV('./fileTinHieuMoi/phone_F1.wav', 'phone female');
%Fo_phone_ma = V_UV('./fileTinHieuMoi/phone_M1.wav', 'phone male');
%Fo_studio_fe = V_UV('./tinHieuHuanLuyen/01MDA.wav', 'studio female');
